...
- [Ver página](https://loopstudios.onrender.com/)

## Descripción 📑

Sitio web estático responsive, basado en el diseño proporcionado por Frontend Mentor.

## ¿Qué he aprendido en este proyecto? 🙇🏻

Con este proyecto he aprendido a usar una nueva forma de organizar mi código con Sass y ha usar Vite para compilar.
...
Este proyecto necesita instalación, en la terminal escribir npm run dev y si sólo quieres verlo npm run preview, o visitar el sitio en el link de arriba.
